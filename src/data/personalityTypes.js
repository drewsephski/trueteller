export const PERSONALITY_TYPES = {
  ...
  INFJ: {
    ...
    personalityTraits: 'Quietly inspiring and tireless, you approach life with deep thoughtfulness and imagination. You have a strong sense of idealism and morality, and you are not content to drift through life—you want to stand up and make a difference.',
  ...
  INTJ: {
    ...
    personalGrowth: 'While your logic is a powerful tool, practice considering the emotional element in decisions. Learn to value the input of others, even if it doesn\'t seem perfectly rational at first. Spontaneity can be a strength, not a flaw—try embracing it occasionally.',
    strengthsWeaknesses: {
  ...
  ESTP: {
    ...
    personalityTraits: 'You have an impact on your immediate surroundings – the best way to spot an Entrepreneur is to look for the whirlwind of energy that swirls around them. You love to be the center of attention and live for the drama, passion, and pleasure of the moment.',
  ...
  ESTJ: {
    ...
    personalityTraits: 'You are a classic image of the model citizen. You are an organizer, and you do a great job of managing things – or people. You are a representative of tradition and order, using your understanding of what is right, wrong, and socially acceptable to bring families and communities together.',
    ...
    careerInsights: {
      ...
      workspaceHabits: 'You are a pillar of the office—organized, efficient, and a clear leader. You expect everyone to do their part and have little patience for inefficiency or excuses.',
    },
    relationshipsConnections: {
